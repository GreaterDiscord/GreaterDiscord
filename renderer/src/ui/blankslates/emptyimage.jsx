...
export default function EmptyImage(props) {
    return <div className={`gd-empty-image-container ${EmptyImageClasses.emptyContainer}` + (props.className ? ` ${props.className}` : "")}>
                <div className={`gd-empty-image ${EmptyImageClasses.emptyImage}`}></div>
                <div className={`gd-empty-image-header ${EmptyImageClasses.emptyHeader}`}>
                    {props.title || "You don't have anything!"}
                </div>
                <div className={`gd-empty-image-message`}>
